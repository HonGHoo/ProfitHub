...
<template>
  <div class="app-container">
    <div class="game-info">
      <GameInfo />
      <div>
        <ActionConfig :show-compare="true" :actions="['alchemy']" :equipments="['hands', 'neck', 'earrings', 'ring', 'pouch']" @toggle-compare="!isComparing && (showCompareSelector = !showCompareSelector)" />
      </div>

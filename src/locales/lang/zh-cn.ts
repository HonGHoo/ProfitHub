export default {
  ...
  "神龛数据不完整（{0}/5），缺失的按等级0计算；请在游戏内打开公会页面待其加载后重新导出（插件3.1.2+已修复，无公会可忽略）": "神龛数据不完整（{0}/5），缺失的按等级0计算；请在游戏内打开公会页面待其加载后重新导出（插件3.1.2+已修复，无公会可忽略）",
  "{0} 种来源参与排行（{1} 种当前无卖单未计入）": "{0} 种来源参与排行（{1} 种当前无卖单未计入）",
  "{0} 种来源参与排行（无卖单的按制造成本计入，{1} 种无法定价未计入）": "{0} 种来源参与排行（无卖单的按制造成本计入，{1} 种无法定价未计入）",
  "每次制作 {0} 片，工匠节省 {1}": "每次制作 {0} 片，工匠节省 {1}",
